...
expName = 'Exp2_Stroop Effect'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\saksh\\OneDrive\\Desktop\\PSYCHOPY\\PSYCHOPY EXPERIMENTS\\Exp2- Stroop Effect\\Exp2_Stroop Effect_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Conditions defined.xlsx'), 
        seed=None, 
    )
